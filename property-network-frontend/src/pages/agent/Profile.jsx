      ...
      <div style={{ display: 'grid', gridTemplateColumns: '320px 1fr', gap: '24px', alignItems: 'start' }}>
        ...
        <div style={{
          ...
          <div style={{ padding: '18px 24px' }}>
            <p style={{ ...fieldLabel, marginBottom: '6px' }}>Verification Status</p>
            <span style={{
              ...
              color: profile?.is_verified ? '#065f46' : '#92400e'
            }}>
          ...
          {!editing ? (
            <>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '28px' }}>
                ...
                <div>
                  ...
                  <p style={fieldValue}>{profile?.agency_name || '—'}</p>
                </div>
                <div>
                  <p style={fieldLabel}>Agent ID</p>
                  <p style={fieldValue}>#{profile?.agent_id}</p>
                </div>
              </div>
            </>
          ) : (
            <>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '20px', marginBottom: '28px' }}>
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '13px', color: '#6b7280', marginBottom: '6px' }}>Agency Name</label>
